...
//#define NRF24L01_CSN  PCout(14)//PCout(4) //SPI片选信号     
//#define NRF24L01_IRQ  PCin(15) //PCin(5)  //IRQ主机数据输入
//24L01发送接收数据宽度定义
#define TX_ADR_WIDTH    5   //5字节的地址宽度
#define RX_ADR_WIDTH    5   //5字节的地址宽度
#define TX_PLOAD_WIDTH  32  //0x20字节的用户数据宽度
#define RX_PLOAD_WIDTH  32  //0x20字节的用户数据宽度
...
#define WR_ACK_PAYLOAD    0xA8  //写TX ACK附带数据,1~32字节
#define WR_TX_PLOAD_NOACK 0xB0  //写TX有效数据(无需ACK),1~32字节
#define FLUSH_TX        0xE1  //清除TX FIFO寄存器.发射模式下用
#define FLUSH_RX        0xE2  //清除RX FIFO寄存器.接收模式下用
#define REUSE_TX_PL     0xE3  //重新使用上一包数据,CE为高,数据包被不断发送.
#define R_RX_PL_WID     0x60  //读取动态数据长度接受时读取接受到有效数据的数目
...
#define DYNPD           0x1C  //Enable dynamic payload length,低6位分别对应DPL_P5至DPL_P0
#define FEATURE         0x1D  //Feature Register,D2:EN_DPL,D1:EN_ACK_PAY,D0:EN_DYN_ACK
//////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void RX2TX(void);//从接收模式切换到发送模式
void TX2RX(void);//从发送模式切换到接收模式
